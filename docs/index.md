...
!!! abstract "New to salt? Start the tutorial series: [1. MNIST](tutorials/mnist.md) → [2. your own CNN module](tutorials/mnist_cnn.md) → [3. event-level tagging with easyjet](tutorials/event_classifier.md) → [4. GN2 jet tagging on open data](tutorials/gn2_opendata.md) → [5. boosted Xbb tagging](tutorials/xbb.md) → [6. fine-tuning a pretrained tagger](tutorials/finetuning.md)"
