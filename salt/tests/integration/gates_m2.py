...
Five standalone gates, each a subcommand of ``python -m salt.tests.integration.gates_m2``,
...
from salt.tests._fixtures.gn2v2_fixture import build_gn2v2_modules, compile_gn2v2
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m salt.tests.integration.gates_m2", description=__doc__.splitlines()[0]
    )
