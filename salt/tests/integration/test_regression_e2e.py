...
Historical note (plan 47): this file was the regression CUTOVER A/B gate,
...
parity-closure section of ``salt/core/README.md``); what remains is the live
...
def eval_h5(data, ckpt, tmp_path_factory) -> Path:
    ...
    out = tmp_path_factory.mktemp("reg_e2e_eval") / "eval.h5"
    rc = main([
        "test",
        "--config",
        str(REGRESSION_CFG),
