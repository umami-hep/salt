...
Standalone gates, each a subcommand of ``python -m salt.tests.integration.gates_m7``, each
...
from salt.tests.integration.gates_m5 import _CONV_CONFIGS as _M5_CONV_CONFIGS
from salt.tests.integration.gates_m5 import _conv_set_args as _m5_conv_set_args
from salt.tests.integration.gates_m6 import _CONV_M6_CONFIGS as _M6_CONV_CONFIGS
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m salt.tests.integration.gates_m7", description=__doc__.splitlines()[0]
    )
