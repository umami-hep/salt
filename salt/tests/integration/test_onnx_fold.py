...
nodes AND the MaskFormer object nodes.

Merges ``test_onnx_fold_classification.py`` + ``test_onnx_fold_objects.py`` —
same mechanism (``compile_onnx_plan`` -> ``export_graph`` -> ORT vs torch), same
helper set, split only by node family in the two source files.
...
# =====================================================================
# classification + combination nodes
# =====================================================================
