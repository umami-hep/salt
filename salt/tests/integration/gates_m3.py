...
Five standalone gates, each a subcommand of ``python -m salt.tests.integration.gates_m3``,
...
writers:
  modules:
    valid_count: {class_path: salt.tests.integration.gates_m3.ValidCountWriter}
"""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m salt.tests.integration.gates_m3", description=__doc__.splitlines()[0]
    )
